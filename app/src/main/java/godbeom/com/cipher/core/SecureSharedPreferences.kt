...
class SecureSharedPreferences(private val sharedPref: SharedPreferences) {
    ...
    //add Async
    fun get(key: String, defaultValue: Boolean ,onResult:(Boolean) -> Unit) = getInternal(key, defaultValue,onResult)
    fun get(key: String, defaultValue: Int ,onResult:(Int) -> Unit) = getInternal(key, defaultValue,onResult)
    fun get(key: String, defaultValue: Long ,onResult:(Long) -> Unit) = getInternal(key, defaultValue,onResult)
    fun get(key: String, defaultValue: String ,onResult:(String) -> Unit) = getInternal(key, defaultValue,onResult)
    ...
    private fun <T : Any> getInternal(key: String, defaultValue: T, onResult:(T) -> Unit) {
    ...
    fun getCyptStr(key:String):String{
        return  sharedPref.getString(key, "defCypt")
    }
    companion object {
